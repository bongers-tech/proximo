...
import static tech.bongers.nativetech.common.util.NativeProperties.FACING;
...
public abstract class AbstractNativeTileBlock extends Block {
    ...
    public AbstractNativeTileBlock(final Properties properties) {
        ...
        this.setDefaultState(this.stateContainer.getBaseState()
                .with(NativeProperties.FACING, Direction.NORTH)
                .with(NativeProperties.ACTIVE, false));
    }

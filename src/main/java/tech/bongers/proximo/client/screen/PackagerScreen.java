 ...
 */
package tech.bongers.proximo.client.screen;
...
import static tech.bongers.proximo.common.util.ProximoProperties.PATH_GUI;

public class PackagerScreen extends ContainerScreen<PackagerContainer> {

    private static final ResourceLocation TEXTURE = new ResourceLocation(Proximo.MOD_ID, PATH_GUI + PACKAGER + ".png");

...
import tech.bongers.proximo.legacy.common.util.FunctionalIntReferenceHolder;

import java.util.Objects;

import static tech.bongers.proximo.legacy.common.tileentity.PackagerTileEntity.PROCESSING_TIME;
